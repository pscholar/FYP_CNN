...
model.load_weights(filepath="mrcnn_weights\mask_rcnn_flood_vehicle_0058.h5",
                   by_name=True)
...
best_ref, homography_matrix, flag,matched_img = dp.get_homography_matrix(ref1,ref2,subimage,start_x,start_y)
