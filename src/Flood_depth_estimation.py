...
if __name__ == "__main__":
    ...
    cv2.imshow("Image Viewer3", img)
    cv2.waitKey(0)
    cv2.destroyAllWindows()
    cv2.imshow("Image Viewer4", detected_edges)
    cv2.waitKey(0)
    cv2.destroyAllWindows()
    # viewer = skimage.viewer.ImageViewer(image=img)
    # viewer.show()
    ...
    cv2.imshow("Image Viewer5", bottle_clone)
    cv2.waitKey(0)
    cv2.destroyAllWindows()
    ...
    cv2.imshow("Image Viewer6", bottle_clone)
    cv2.waitKey(0)
    cv2.destroyAllWindows()
    # viewer = skimage.viewer.ImageViewer(image=bottle_clone)
    # viewer.show()
    ...
    cv2.imshow("Image Viewer7", image)
    cv2.waitKey(0)
    cv2.destroyAllWindows()
